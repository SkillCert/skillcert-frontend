...
export async function healthCheckCourseRegistry(): Promise<string> {
  ...
  if (!contractId) throw new Error("Missing NEXT_PUBLIC_COURSE_REGISTRY_CONTRACT_ID environment variable.");
