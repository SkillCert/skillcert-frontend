          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Link href="/coursesPage" className="block text-gray-300 hover:text-white transition-colors">
                  Courses
                </Link>
                <Link href="/instructor" className="block text-gray-300 hover:text-white transition-colors">
                  Instructors
                </Link>
