  ...
  ({ 
    ...
    return (
      <div className="w-full space-y-2">
        {label && (
          <label className="text-base font-bold text-gray-300 leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70" style={{ fontFamily: 'Segoe UI', lineHeight: '100%', letterSpacing: '0%', verticalAlign: 'middle' }}>
            {label}
          </label>
        )}
        ...
        <div className="relative">
          {variant === "text" ? (
               ...
               style={{ fontFamily: 'Segoe UI', fontWeight: 400, lineHeight: '100%', letterSpacing: '0%', verticalAlign: 'middle' }}
            ...
            <div className="relative">
                 ...
                 style={{ fontFamily: 'Segoe UI', fontWeight: 400, lineHeight: '100%', letterSpacing: '0%', verticalAlign: 'middle' }}
               >
                 <span className={selectedOption ? "text-[#9CA3AF]" : "text-[#9CA3AF]"}>
