  ...
  return (
    <header className="bg-slate-900 font-poppins h-[155px] px-[7px] flex items-center justify-between my-6">
      <div className="flex flex-col gap-y-5 items-start justify-center h-[103px">
        <h1 className="text-white leading-[100%] text-[40px] font-medium align-top">
          Course management
        </h1>
      ...
      <div className="flex items-center gap-5 font-semibold font-sans">
        <Button
          variant="secondary"
          className="bg-gray-800 text-gray-400 py-[6px] px-[12px] justify-center items-center gap-[10px] rounded-xl hover:bg-gray-700"
        >
          <Image
            src="/svg/Save.svg"
            alt="publish course"
