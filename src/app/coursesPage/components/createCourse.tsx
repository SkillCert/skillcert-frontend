...
import { useCreateCourse, type CreateCourseParams } from "../../../contract_connections/CourseRegistry/createCourse";
...
export default function CreateCourse() {
  ...
  const handleInputChange = (field: keyof CreateCourseParams, value: string) => {
    setFormData(prev => ({
      ...prev,
      ...
      <DialogContent className="bg-gray-950 border-none sm:rounded-2xl gap-[26px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2.5">
            <Label htmlFor="course-name" className="text-base font-bold text-white">
          ...
          <div className="space-y-2.5">
            <Label htmlFor="course-description" className="text-base font-bold text-white">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-2.5">
              <Label htmlFor="course-price" className="text-base font-bold text-white">
